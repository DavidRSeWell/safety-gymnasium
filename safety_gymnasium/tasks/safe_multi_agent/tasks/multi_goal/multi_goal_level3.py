...
class MultiGoalLevel3(BaseTask):
    ...
    def calculate_reward(self):
        ...
        dist_goal_red = self.dist_opp_red()
        reward['agent_0'] += (
        ...
        dist_goal_blue = self.dist_opp_blue()
        reward['agent_1'] += (
            dist_goal_blue - self.last_dist_goal_blue
    ...
    def update_world(self):
        ...
        self.last_dist_goal_red = self.dist_opp_red()
        self.last_dist_goal_blue = self.dist_opp_blue()
